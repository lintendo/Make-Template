...
- "Render the Apple TV bottom tab bar: 64pt + safe area, translucent material `rgba(0,0,0,0.92)` `blur(20px) saturate(180%)`, 0.33pt top hairline `#38383A`. Four tabs Watch Now / TV+ / Store / Search, 24pt web-accessible icon. Active = `#0A84FF` filled glyph, inactive = `#636366` stroked glyph, no tint pill. Labels SF Pro 12pt w500 always shown. Content scrolls behind it (vibrancy)."
