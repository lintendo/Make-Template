...
const teamMembers: TeamMember[] = [
  { id: "1", name: "Sarah Chen", role: "高级客户经理", email: "sarah@company.com", avatar: "SC", deals: 24, revenue: 487500, quota: 450000, change: 15, rank: 1 },
  { id: "2", name: "Mike Johnson", role: "客户经理", email: "mike@company.com", avatar: "MJ", deals: 19, revenue: 356200, quota: 400000, change: 8, rank: 2 },
  { id: "3", name: "Emily Davis", role: "高级客户经理", email: "emily@company.com", avatar: "ED", deals: 17, revenue: 312800, quota: 350000, change: 12, rank: 3 },
  { id: "4", name: "James Wilson", role: "客户经理", email: "james@company.com", avatar: "JW", deals: 15, revenue: 289400, quota: 350000, change: -5, rank: 4 },
  { id: "5", name: "Lisa Park", role: "客户经理", email: "lisa@company.com", avatar: "LP", deals: 14, revenue: 267100, quota: 300000, change: 9, rank: 5 },
];
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-2 gap-4 mb-4">
        ...
        <div>
          <p className="text-xs text-muted-foreground mb-1">成交数</p>
      ...
      <div className="mb-4">
        <div className="flex items-center justify-between text-xs mb-1.5">
          <span className="text-muted-foreground">配额达成率</span>
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="bg-card border border-border rounded-xl p-5 animate-in fade-in slide-in-from-bottom-4 duration-500">
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="text-sm text-muted-foreground">团队收入</span>
          </div>
        ...
        <div className="bg-card border border-border rounded-xl p-5 animate-in fade-in slide-in-from-bottom-4 duration-500 delay-100">
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="text-sm text-muted-foreground">交易总数</span>
          </div>
        ...
        <div className="bg-card border border-border rounded-xl p-5 animate-in fade-in slide-in-from-bottom-4 duration-500 delay-200">
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="text-sm text-muted-foreground">平均配额达成率</span>
          </div>
      ...
      <div className="bg-card border border-border rounded-xl p-5 animate-in fade-in slide-in-from-bottom-4 duration-500 delay-150">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h3 className="text-base font-semibold text-foreground">收入与配额</h3>
            <p className="text-sm text-muted-foreground mt-0.5">个人业绩对比</p>
          </div>
          <div className="flex items-center gap-4 text-xs">
            <div className="flex items-center gap-1.5">
              <div className="w-2.5 h-2.5 rounded-full bg-chart-1" />
              <span className="text-muted-foreground">收入 (k)</span>
            </div>
            <div className="flex items-center gap-1.5">
              <div className="w-2.5 h-2.5 rounded-full bg-muted-foreground/30" />
              <span className="text-muted-foreground">配额 (k)</span>
            </div>
          </div>
        </div>
      ...
      {/* Team members grid */}
      <div>
        <h3 className="text-base font-semibold text-foreground mb-4">团队成员</h3>
