...
const deals: Deal[] = [
  { id: "1", company: "Acme Corporation", contact: "John Smith", email: "john@acme.com", value: 125000, stage: "谈判", status: "won", closeDate: "2024-01-15", rep: "Sarah Chen" },
  { id: "2", company: "TechStart Inc", contact: "Lisa Wong", email: "lisa@techstart.io", value: 89500, stage: "方案", status: "pending", closeDate: "2024-01-22", rep: "Mike Johnson" },
  { id: "3", company: "GlobalFin Partners", contact: "Robert Davis", email: "rdavis@globalfin.com", value: 245000, stage: "已确认", status: "pending", closeDate: "2024-02-01", rep: "Emily Davis" },
  { id: "4", company: "DataSync Solutions", contact: "Emma Wilson", email: "emma@datasync.net", value: 67800, stage: "线索", status: "lost", closeDate: "2024-01-10", rep: "James Wilson" },
  { id: "5", company: "CloudBase Ltd", contact: "Michael Chen", email: "m.chen@cloudbase.io", value: 178000, stage: "谈判", status: "won", closeDate: "2024-01-18", rep: "Sarah Chen" },
  { id: "6", company: "Innovate Labs", contact: "Jennifer Park", email: "jpark@innovate.co", value: 156000, stage: "方案", status: "pending", closeDate: "2024-01-28", rep: "Lisa Park" },
  { id: "7", company: "NextGen Systems", contact: "David Lee", email: "david@nextgen.tech", value: 203000, stage: "已确认", status: "pending", closeDate: "2024-02-05", rep: "Mike Johnson" },
  { id: "8", company: "Prime Analytics", contact: "Sarah Johnson", email: "sj@primeanalytics.com", value: 94500, stage: "线索", status: "pending", closeDate: "2024-02-10", rep: "Emily Davis" },
];

const statusConfig = {
  won: { icon: CheckCircle2, color: "text-success", bg: "bg-success/10", label: "已赢单" },
  pending: { icon: Clock, color: "text-warning", bg: "bg-warning/10", label: "跟进中" },
  lost: { icon: XCircle, color: "text-destructive", bg: "bg-destructive/10", label: "已流失" },
};
...
export function DealsSection() {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <p className="text-sm text-muted-foreground">集中查看并管理所有交易</p>
      </div>
      ...
      <div className="bg-card border border-border rounded-xl overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-500">
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-border bg-secondary/50">
                ...
                <th className="text-left py-3 px-4 text-xs font-semibold text-muted-foreground uppercase tracking-wider">联系人</th>
                <th className="text-left py-3 px-4 text-xs font-semibold text-muted-foreground uppercase tracking-wider">
                  <button className="flex items-center gap-1 hover:text-foreground transition-colors">
                    金额
                    <ArrowUpDown className="w-3 h-3" />
                ...
                <th className="text-left py-3 px-4 text-xs font-semibold text-muted-foreground uppercase tracking-wider">阶段</th>
                ...
                <th className="text-left py-3 px-4 text-xs font-semibold text-muted-foreground uppercase tracking-wider">预计成交日</th>
        ...
        <div className="flex items-center justify-between px-4 py-3 border-t border-border bg-secondary/30">
          <span className="text-sm text-muted-foreground">
            共 {deals.length} 笔交易，当前显示 {filteredDeals.length} 笔
          </span>
          <div className="flex items-center gap-2">
