...
const useCases = [
  {
    category: "电商",
    question: "如何自动处理订单追踪和物流咨询？",
    icon: ShoppingCart,
  },
  {
    category: "账单",
    question: "需要自动处理订阅管理和付款问题吗？",
    icon: CreditCard,
  },
  {
    category: "退换货",
    question: "想简化退款申请和退货流程吗？",
    icon: RefreshCw,
  },
  {
    category: "FAQ",
    question: "如何在问题进入人工客服前拦截常见咨询？",
    icon: HelpCircle,
  },
  {
    category: "7x24 支持",
    question: "需要全天候支持，又不想安排夜班人力？",
    icon: Clock,
  },
  {
    category: "多语言",
    question: "想即时支持多语言客户吗？",
    icon: Globe,
  },
  {
    category: "合规",
    question: "想确保每次回复都一致且合规？",
    icon: Shield,
  },
  {
    category: "主动触达",
    question: "如何在问题出现前主动触达客户？",
    icon: Megaphone,
  },
]
...
export function UseCases({ gradeTexture }: { gradeTexture: string }) {
  ...
  return (
    <section id="features" className="relative py-12 sm:py-20 overflow-hidden">
      ...
      >
        <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: `url(${gradeTexture})` }} />
      </div>
