...
const activities: Activity[] = [
  {
    ...
    type: "order",
    title: "新订单已创建",
    description: "iPhone 15 Pro 订单 #3210",
    time: "2 分钟前",
    user: {
      name: "Olivia Martin",
  ...
  },
  {
    ...
    type: "review",
    title: "收到商品评价",
    description: "MacBook Air M2 收到 5 星评价",
    time: "1 小时前",
    user: {
  ...
  return (
    <div className="bg-white dark:bg-[#0F0F12] rounded-xl p-6 border border-gray-200 dark:border-[#1F1F23]">
      <div className="flex items-center justify-between mb-6">
        <h3 className="text-lg font-semibold text-gray-900 dark:text-white">近期动态</h3>
