  ...
  return (
    <Card className="bg-white dark:bg-gray-800">
      <CardHeader>
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400">管理网站和表现</p>
      </CardHeader>
      <CardContent>
          ...
          {websites.map((website, index) => (
            <div key={index} className="p-4 border border-gray-200 dark:border-gray-600 rounded-lg">
              ...
              <div className="flex items-center mb-3">
                ...
                <span className="text-sm text-gray-600 dark:text-gray-300">{website.visitors} 访客</span>
              </div>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between text-sm">
                  <div className="flex items-center">
                    ...
                    <span className="text-gray-600 dark:text-gray-300">移动端</span>
                  </div>
                ...
                <div className="flex items-center justify-between text-sm">
                  <div className="flex items-center">
                    ...
                    <span className="text-gray-600 dark:text-gray-300">桌面端</span>
                  </div>
