            ...
            <div className="p-4">
              ...
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-2">
                  ...
                  <h2 className="text-lg font-semibold">主题自定义</h2>
                </div>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-2">
                    ...
                    <Label className="font-medium">菜单</Label>
                  </div>
                  <Select
                ...
                <div className="space-y-3">
                  ...
                  <Select value={config.layout} onValueChange={(value: "ltr" | "rtl") => updateConfig("layout", value)}>
                    ...
                    <SelectContent className="z-[110]">
                      <SelectItem value="ltr">从左到右（LTR）</SelectItem>
                      <SelectItem value="rtl">从右到左（RTL）</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
                ...
                {/* Color Mode Toggle */}
                <div className="flex items-center justify-between">
                  <Label className="font-medium">编辑深色配色</Label>
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-2">
                    ...
                    <Label className="font-medium">颜色（{editingDarkMode ? "深色" : "浅色"}）</Label>
                  </div>
                  ...
                  <div className="grid gap-3 max-h-80 overflow-y-auto">
                    ...
                    <Separator />
                    <Label className="text-sm font-medium text-gray-700 dark:text-gray-300">菜单颜色</Label>
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-2">
                    ...
                    <Label className="font-medium">卡片</Label>
                  </div>

                  <div className="space-y-3">
                    <div>
                      <Label className="text-xs font-medium">圆角：{config.card.borderRadius}px</Label>
                      <Slider
                    ...
                    <div>
                      <Label className="text-xs font-medium">边框宽度：{config.card.borderWidth}px</Label>
                      <Slider
                    ...
                    <div>
                      <Label className="text-xs font-medium">内边距：{config.card.padding}px</Label>
                      <Slider
                ...
                {/* Button Settings */}
                <div className="space-y-3">
                  <Label className="font-medium">按钮</Label>
                  <div className="space-y-3">
                    <div>
                      <Label className="text-xs font-medium">圆角：{config.button.borderRadius}px</Label>
                      <Slider
                    ...
                    <div>
                      <Label className="text-xs font-medium">字号：{config.button.fontSize}px</Label>
                      <Slider
                ...
                {/* Typography Settings */}
                <div className="space-y-3">
                  <Label className="font-medium">排版</Label>
                  <div className="space-y-3">
                    <div>
                      <Label className="text-xs font-medium">字号：{config.typography.fontSize}px</Label>
                      <Slider
                    ...
                    <div>
                      <Label className="text-xs font-medium">字重</Label>
                      <Select
                    ...
                    <div>
                      <Label className="text-xs font-medium">行高：{config.typography.lineHeight}</Label>
                      <Slider
