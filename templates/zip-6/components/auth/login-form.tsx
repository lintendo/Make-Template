    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 text-white">
          ...
          {/* Main Content */}
          <h1 className="text-4xl font-bold mb-6">强大的内容管理系统</h1>
          ...
          <div className="space-y-6 mb-12">
            <div className="flex items-center">
              ...
              <div>
                <h3 className="font-semibold">多站点管理</h3>
                <p className="text-slate-400 text-sm">通过一个仪表盘轻松管理多个网站。</p>
              </div>
            </div>
            ...
            <div className="flex items-center">
              ...
              <div>
                <h3 className="font-semibold">高级分析</h3>
                <p className="text-slate-400 text-sm">通过详尽分析和洞察追踪内容表现。</p>
              </div>
            </div>
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-slate-400 text-sm">借助基于角色的权限，让团队协作更顺畅。</p>
              </div>
            </div>
          </div>
          ...
          <blockquote className="border-l-4 border-blue-500 pl-6">
            <p className="text-slate-300 italic mb-2">
              "这个 CMS 改变了我们管理内容的方式。界面直观，功能也正是我们所需要的。"
            </p>
            <cite className="text-sm text-slate-400">John Doe，内容经理</cite>
          </blockquote>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-slate-600">登录账户后继续管理你的内容</p>
          </div>
