    ...
    <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col justify-center px-12 py-16 text-white">
        <div className="mb-8">
          ...
          <h2 className="text-2xl font-bold mb-6 leading-tight">强大的内容管理系统</h2>
          <p className="text-xl text-slate-300 mb-8 leading-relaxed">
            用完整的 CMS 平台简化内容创作，轻松管理多个网站，并提升团队效率。
          </p>
        </div>
        ...
        <div className="space-y-6">
          <div className="flex items-start space-x-4">
            ...
            <div>
              <h3 className="font-semibold text-lg mb-2">多站点管理</h3>
              <p className="text-slate-300">通过一个仪表盘轻松管理多个网站。</p>
            </div>
          </div>
          ...
          <div className="flex items-start space-x-4">
            ...
            <div>
              <h3 className="font-semibold text-lg mb-2">高级分析</h3>
              <p className="text-slate-300">通过详尽分析和洞察追踪内容表现。</p>
            </div>
          </div>
          ...
          <div className="flex items-start space-x-4">
            ...
            <div>
              <h3 className="font-semibold text-lg mb-2">团队协作</h3>
              <p className="text-slate-300">借助基于角色的权限，让团队协作更顺畅。</p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-slate-700">
          <p className="text-slate-400 text-sm">
            "CMS Full Form 改变了我们管理内容的方式。直观的界面和强大的功能让使用过程非常顺手。"
          </p>
          <div className="flex items-center mt-4">
            ...
            <div>
              ...
              <p className="text-slate-400 text-sm">内容经理，TechCorp</p>
            </div>
          </div>
        </div>
      </div>
