  ...
  return (
    <div className="bg-white dark:bg-[#0F0F12] rounded-xl p-6 border border-gray-200 dark:border-[#1F1F23]">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6 gap-4">
        <div>
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white">媒体库</h3>
          <p className="text-sm text-gray-600 dark:text-gray-400">管理图片、视频和文档</p>
        </div>
        ...
        {mediaFiles.map((file) => (
          ...
          >
            ...
            <div className="flex items-center justify-between mb-3">
              <Badge className={`${getFileColor(file.type)} border-0 text-xs`}>{fileTypeLabels[file.type]}</Badge>
      ...
      <div className="mt-6 pt-4 border-t border-gray-200 dark:border-gray-700">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="text-sm text-gray-600 dark:text-gray-400">
            正在显示 {mediaFiles.length} / 1,247 个文件，已用 2.4 GB / 10 GB
          </div>
