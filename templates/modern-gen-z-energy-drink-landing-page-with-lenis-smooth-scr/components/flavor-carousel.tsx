...
import drinkPineappleCoconut from "../public/images/drink1.png"
import drinkLemonLime from "../public/images/drink2.png"
import drinkMystery from "../public/mystery-energy-drink-can-silhouette.jpg"
...
const flavors = [
  {
    ...
    name: "柠檬青柠",
    tagline: "柑橘电击",
    description: "天然柠檬与青柠的清爽爆发，一口把状态拉满。",
    image: drinkLemonLime,
  ...
  },
  {
    ...
    name: "菠萝椰子",
    tagline: "热带冲刺",
    description: "每一口都有海岛气息，把自己送进高光假日。",
    image: drinkPineappleCoconut,
                  ...
                  <div className="grid md:grid-cols-2 gap-6 items-center">
                    ...
                    >
                      <img
                        ...
                        className={`h-full w-full object-contain ${currentFlavor.mystery ? "blur-sm grayscale" : ""}`}
                      />
                      {currentFlavor.mystery && (
                        <motion.div
                    ...
                    <div className="space-y-4">
                      ...
                      {currentFlavor.mystery && (
                        ...
                        >
                          ...
                          />
                          <span className="font-mono text-xs text-[#121212]/60">即将开售...</span>
                        </motion.div>
                      )}
                    </div>
                  </div>
