...
import drinkLemonLime from "../public/images/drink2.png"
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-24 pb-12">
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          {/* Text Content */}
          <motion.div style={{ opacity }} className="min-w-0 space-y-5">
            <motion.div
            ...
            <div className="space-y-1 overflow-hidden">
              ...
              <motion.p
                ...
                animate="visible"
                custom={3}
                className="max-w-[20rem] pt-2 font-mono text-base leading-relaxed tracking-tight text-[#121212]/60 md:max-w-md md:text-xl"
              >
                零糖、天然风味，干净利落的能量补给，醒得更漂亮。
              </motion.p>
            </div>
            ...
            >
              <motion.button
                className="group relative flex w-full max-w-[20rem] items-center justify-center gap-2 overflow-hidden rounded-full bg-[#AFFF00] px-6 py-3 text-sm font-bold tracking-wide text-[#121212] sm:w-auto"
              ...
              >
                ...
                />
                <span className="relative z-10">订阅立省 25%</span>
                <motion.svg
              ...
              <motion.button
                className="relative w-full max-w-[20rem] overflow-hidden rounded-full border-2 border-[#121212] px-6 py-3 text-sm font-bold tracking-wide text-[#121212] sm:w-auto"
            ...
            >
              {["零糖", "75mg 咖啡因", "天然风味", "富含维生素 B"].map((benefit, i) => (
                <motion.div
                  key={benefit}
