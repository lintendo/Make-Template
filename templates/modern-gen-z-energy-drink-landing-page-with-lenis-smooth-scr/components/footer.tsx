...
export function Footer() {
  ...
  const footerLinks = [
    {
      title: "产品",
      links: ["柠檬青柠", "菠萝椰子", "神秘口味", "组合装"],
    },
    {
      title: "快速链接",
      links: ["首页", "口味", "创作者", "合作渠道"],
    },
    {
      title: "公司",
      links: ["关于我们", "加入我们", "媒体", "联系"],
    },
    {
      title: "法律",
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <p className="text-white/60 font-mono text-xs max-w-xl mx-auto leading-relaxed">
            GiGi Energy 是一款更轻负担的能量饮料，以天然风味、零糖配方和干净能量感打造。给野心充电，不让状态坠落。
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="text-white/40 font-mono text-xs">© 2026 GiGi Energy. 保留所有权利。</p>
