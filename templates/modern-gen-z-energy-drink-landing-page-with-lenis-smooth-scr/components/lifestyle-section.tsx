...
const socialPosts = [
  { handle: "@creativekatie", text: "GiGi 陪我扛完整张专辑制作，真的有电。", likes: "2.4k" },
  { handle: "@fitnessjay", text: "零糖，但能量感 100%。就是这一罐。", likes: "1.8k" },
  { handle: "@techbro_sam", text: "终于有一款不像化学糖水的能量饮料了。", likes: "956" },
]
