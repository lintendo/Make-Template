  ...
  const principles = [
    {
      number: "01",
      titleParts: [
        { text: "界面", highlight: true },
        { text: "极简主义", highlight: false },
      ],
      description: "持续删减，直到只剩必要之物。每个元素都必须有存在的理由。",
      align: "left",
    },
    {
      number: "02",
      titleParts: [
        { text: "系统", highlight: true },
        { text: "优先于屏幕", highlight: false },
      ],
      description: "设计行为，而不只是布局。构建能够扩展的逻辑。",
      align: "right",
    },
    {
      number: "03",
      titleParts: [
        { text: "受控的", highlight: false },
        { text: "张力", highlight: true },
      ],
      description: "在克制与表达之间取得平衡。保持自信，但不过度。",
      align: "left",
    },
    {
      number: "04",
      titleParts: [
        ...
        { text: "清晰度", highlight: true },
      ],
      description: "让沟通穿透噪声。每一次交互都保持精准。",
      align: "right",
    },
  ]
  ...
  return (
    <section ref={sectionRef} id="principles" className="relative py-32 pl-6 md:pl-28 pr-6 md:pr-12">
      ...
      <div ref={headerRef} className="mb-24">
        <span className="font-mono text-[10px] uppercase tracking-[0.3em] text-accent">03 / 原则</span>
        <h2 className="mt-4 font-[var(--font-bebas)] text-5xl md:text-7xl tracking-tight">工作方式</h2>
      </div>
