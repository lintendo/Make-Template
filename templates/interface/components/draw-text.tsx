    ...
    >
      {characters.map((char, index) => (
        <span
          ...
          style={{
            backgroundColor: activeIndices[index] ? "oklch(0.7 0.2 45)" : "transparent",
            color: activeIndices[index] ? "oklch(0.08 0 0)" : flippingIndices[index] ? "oklch(0.7 0.2 45)" : "transparent",
