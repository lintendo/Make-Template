            ...
            <BlurPanel className="p-8 lg:p-12 bg-white/40 backdrop-blur-md grain-texture">
              <div className="text-center mb-8">
                <h2 className="text-3xl lg:text-4xl font-bold text-neutral-900 mb-4">
                  <AnimatedText text="先一步感知" delay={0.2} />
                  <span className="italic font-light">
                    <AnimatedText text="安静奢华。" delay={0.5} />
                  </span>
                </h2>
                <p className="text-lg text-neutral-600">
                  第一时间了解新系列、设计观察，以及限量作品的专属购买机会。
                </p>
              </div>
              ...
              {!isSubmitted ? (
                ...
                >
                  ...
                  <h3 className="text-xl font-semibold text-neutral-900 mb-2">欢迎来到 KATACHI</h3>
                  <p className="text-neutral-600">
                    感谢订阅。下一封通讯会为你带来设计观察、专属内容和新品信息。
                  </p>
                </motion.div>
              )}

              <p className="text-xs text-neutral-500 text-center mt-6">
                我们尊重你的隐私，你可以随时退订。阅读我们的{" "}
