        ...
        <div className="grid lg:grid-cols-12 gap-16 lg:gap-20">
          ...
          <div className="lg:col-span-2">
            ...
            >
              ...
              <span className="text-xs tracking-[0.3em] uppercase text-muted-foreground">愿景</span>
            </div>
          </div>
          ...
          <div className="lg:col-span-10">
            <div className="space-y-16 md:space-y-24">
              ...
              <div className="overflow-hidden">
                <h2 
                  className="font-serif text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-light leading-[1.1] tracking-normal text-foreground max-w-5xl text-pretty"
                  style={{
                    opacity: isVisible ? 1 : 0,
                ...
                >
                  我们相信，真正的料理会在入口后退场，只留下情绪、记忆，以及味觉越过餐盘的那个瞬间。
                </h2>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-12 md:gap-20">
                ...
                >
                  <p className="text-lg md:text-xl leading-relaxed text-foreground/80">
                    十余年来，我们以季节的节奏塑造用餐体验：春日第一束芦笋、秋季松露的深度、冬柑的清澈酸香。
                  </p>
                </div>
                <div 
                  className="space-y-6"
                ...
                >
                  <p className="text-lg md:text-xl leading-relaxed text-foreground/80">
                    我们并不追求夸张宣言，而是创造让人真正抵达当下的时刻。一餐留在记忆里，也悄悄改变你理解风味的方式。
                  </p>
                </div>
              </div>
              ...
              >
                {[
                  { value: "12", label: "年卓越积淀" },
                  { value: "3", label: "Michelin 星" },
                  { value: "24", label: "季节菜单" },
                  { value: "100+", label: "招牌创作" },
                ].map((stat, index) => (
