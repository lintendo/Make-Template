/**
 * @name 理财精选好品页 (page-58)
 */
import React from 'react';
import './style.css';

export default function JDWealthHub() {
  ...
  return (
    <div className="w-full min-h-screen obsidian-bg flex flex-col font-sans select-none overflow-x-hidden text-white pb-[30px]">
      ...
      {/* 
        ========================================================================
         TOP NAVIGATION BARS (Floating over grid)
        ========================================================================
      */}
      <div className="w-full flex items-center justify-between px-3 pt-[52px] absolute top-0 left-0 z-20 pointer-events-none">
          <div className="w-8 flex items-center cursor-pointer active:opacity-60 pointer-events-auto mt-2">
              <svg className="w-[28px] h-[28px] text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M15 19l-7-7 7-7" />
              </svg>
          </div>
          <div className="flex space-x-1 items-center cursor-pointer active:opacity-60 pointer-events-auto pr-2 mt-2">
      ...
      {/* 
        ...
        ========================================================================
      */}
      <div className="w-full px-2 pt-[65px] pb-[35px] grid grid-cols-4 gap-y-[22px] gap-x-1 z-10">
          {gridItems.map((item, idx) => (
             <div key={idx} className="flex flex-col items-center cursor-pointer active:scale-95 transition-transform">
                 <div className="grid-icon-box mb-2">
                     ...
                     {item.badge && <div className="badge-dot-green"></div>}
                 </div>
          ...
          {/* Empty 12th slot implicitly sits here */}
      </div>
      ...
      */}
      ...
      {/* 
        ...
        ========================================================================
      */}
      <div className="w-full flex justify-center mt-[35px] mb-[45px]">
      ...
      <div className="w-full flex flex-col items-center opacity-70">
          <div className="flex items-center mb-1">
              <div className="w-[18px] h-[18px] bg-white rounded flex justify-center items-center overflow-hidden mr-1.5 shadow-sm">
                  <div className="w-[8px] h-[4px] bg-[#f04a4b] rounded-t-lg mt-[3px]"></div>
              </div>
              <span className="text-[14px] font-bold tracking-widest text-[#e8dfda]">京东金融</span>
          </div>
          <div className="footer-decor-line mt-1">
              <span>简单 <span className="mx-1">•</span> 快捷 <span className="mx-1">•</span> 安全</span>
          </div>
      </div>
