...
const features = [
  {
    number: "01",
    title: "即时部署",
    description: "几秒内推向 production。边缘网络让你的应用在全球任何地方都能快速加载。",
    visual: "deploy",
  },
  {
    number: "02",
    title: "AI 原生工作流",
    description: "用内置 AI 能力构建智能应用。从推理到训练，所有环节都能自动扩展。",
    visual: "ai",
  },
  {
    number: "03",
    title: "实时协作",
    description: "团队可以无缝共创：实时预览、即时反馈，以及真正清晰的 version control。",
    visual: "collab",
  },
  {
    number: "04",
    title: "企业级安全",
    description: "银行级加密、SOC 2 合规和细粒度访问控制。你的数据始终属于你。",
    visual: "security",
  },
];
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-16 lg:mb-24">
          ...
          >
            需要的能力都在这里。
            <br />
            <span className="text-muted-foreground">不多加任何负担。</span>
          </h2>
        </div>
