...
const features = [
  { 
    title: "TypeScript 原生", 
    description: "完整类型安全，自动生成 types。"
  },
  { 
    title: "零配置", 
    description: "默认配置足够清晰，打开即可运行。"
  },
  { 
    title: "Edge-ready", 
    description: "可运行在 Node、Deno、Bun 和浏览器。"
  },
  { 
    title: "12KB gzipped", 
    description: "轻量体积，无额外 dependencies。"
  },
];
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-start">
          ...
          >
            ...
            <h2 className="text-4xl lg:text-6xl font-display tracking-tight mb-8">
              由开发者构建。
              <br />
              <span className="text-muted-foreground">也为开发者服务。</span>
            </h2>
            <p className="text-xl text-muted-foreground mb-12 leading-relaxed">
              一个不会挡路的 SDK。凭借直觉化 API 和完善文档，让交付速度更快。
            </p>
