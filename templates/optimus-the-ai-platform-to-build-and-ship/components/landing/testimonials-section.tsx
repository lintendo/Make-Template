...
const testimonials = [
  {
    quote: "Optimus 改变了我们的 deployment pipeline。过去要花几小时的事，现在几秒内完成。",
    author: "Sarah Chen",
    role: "CTO",
    company: "Meridian Labs",
    metric: "deployment 提速 10x",
  },
  {
    quote: "developer experience 很出色，团队生产力达到了新水平。",
    author: "Marcus Webb",
    role: "工程负责人",
    company: "Flux Systems",
    metric: "feature 交付增加 40%",
  },
  {
    quote: "终于有了能匹配野心的 infrastructure。切换后一直保持 zero downtime。",
  ...
  {
    quote: "integrations 非常顺畅。我们只用一个下午就连接了完整技术栈。",
    author: "James Liu",
    role: "创始人",
    company: "Prism Analytics",
    metric: "已使用 50+ integrations",
  },
];
