...
import avatar1 from "../public/professional-headshot-1.png"
import avatar2 from "../public/professional-headshot-2.png"
import avatar3 from "../public/professional-headshot-3.png"
import avatar4 from "../public/professional-headshot-4.png"
import avatar5 from "../public/professional-headshot-5.png"
    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center px-4 pt-24 pb-16 overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        >
          ...
          <span className="text-sm text-zinc-400">公测版现已开放</span>
        </motion.div>
        ...
        >
          面向高效团队的现代化平台。为规模化而构建，为速度而设计，提供构建、部署和增长所需的一切能力。
        </motion.p>
        ...
        >
          ...
          <p className="text-sm text-zinc-500">
            已获全球 <span className="text-zinc-300 font-medium">2,000+</span> 支团队信赖
          </p>
        </motion.div>
      </div>
    </section>
