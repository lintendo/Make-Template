...
const plans = [
  {
    ...
    features: ["3 名团队成员", "10 个项目", "基础分析", "社区支持", "1GB 存储空间"],
    cta: "开始使用",
    highlighted: false,
  },
  {
        ...
        >
          ...
          <div className="inline-flex items-center p-1 rounded-full bg-zinc-900 border border-zinc-800">
            ...
            >
              ...
              <span className="relative z-10">按月</span>
            </button>
            <button
            ...
            >
              ...
              <span className="relative z-10">按年</span>
