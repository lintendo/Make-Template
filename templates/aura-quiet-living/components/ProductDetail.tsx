      ...
      <div className="max-w-[1800px] mx-auto px-6 md:px-12 pb-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24">
          ...
          <div className="flex flex-col justify-center max-w-xl">
             <span className="text-sm font-medium text-[#A8A29E] uppercase tracking-widest mb-2">{CATEGORY_LABELS[product.category]}</span>
             ...
             {showSizes && (
                <div className="mb-8">
                  <span className="block text-xs font-bold uppercase tracking-widest text-[#2C2A26] mb-4">选择尺寸</span>
