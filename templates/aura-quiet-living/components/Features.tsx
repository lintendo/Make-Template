    ...
    <section className="bg-[#EBE7DE]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[80vh]">
        ...
        <div className="order-1 lg:order-2 flex flex-col justify-center p-12 lg:p-24 bg-[#EBE7DE]">
           <span className="text-xs font-bold uppercase tracking-[0.2em] text-[#A8A29E] mb-6">我们的理念</span>
           ...
           <p className="text-lg text-[#5D5A53] font-light leading-relaxed mb-12 max-w-md">
             我们拒绝一次性的光鲜。每件 Aura 产品都由砂岩、未抛光铝材与有机织物制成，会在时间中形成独有包浆。
           </p>
           <a href="#" className="inline-block text-sm font-medium uppercase tracking-widest underline underline-offset-8 hover:text-[#8C8881] transition-colors">了解我们的材料</a>
        </div>
      </div>
