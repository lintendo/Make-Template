...
const NODES: Node[] = [
  { id: "input", label: "输入", x: 80, y: 180 },
  { id: "preprocess", label: "预处理", x: 260, y: 80 },
  { id: "model", label: "模型", x: 440, y: 180 },
  { id: "validate", label: "验证", x: 260, y: 280 },
...
export function TopologyGraph() {
  ...
  return (
    <div className="relative w-full border-2 border-foreground bg-background">
      <svg viewBox="0 0 760 360" className="w-full h-auto" role="img" aria-label="AI 系统拓扑图，展示数据从输入经预处理与验证流向模型和输出">
