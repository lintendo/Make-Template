    ...
    <section className="relative w-full px-12 pt-6 pb-12 lg:px-24 lg:pt-10 lg:pb-16">
      <div className="flex flex-col items-center text-center">
        ...
        <motion.h1
          ...
          className="font-pixel text-4xl sm:text-6xl lg:text-7xl xl:text-8xl tracking-normal text-foreground mb-2 select-none"
        >
          部署。扩展。
        </motion.h1>
        ...
        <motion.h1
          ...
          className="font-pixel text-4xl sm:text-6xl lg:text-7xl xl:text-8xl tracking-normal text-foreground mb-4 select-none"
          aria-hidden="true"
        >
          路由。
        </motion.h1>
        ...
        >
          SYS.INT 是连接模型与用户的确定性部署层。低于 5ms 推理。全球边缘路由。完整运维控制。
        </motion.p>
