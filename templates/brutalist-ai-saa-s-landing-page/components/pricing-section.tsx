...
function StatusLine() {
  ...
  return (
    <div className="flex items-center gap-2 text-[10px] tracking-widest text-muted-foreground uppercase font-mono">
      ...
      <span>实时吞吐: {throughput}k req/s</span>
    </div>
  )
}
...
const TIERS: Tier[] = [
  {
    ...
    period: "/ 永久",
    tag: null,
    description: "社区级推理。限速。无 SLA。",
    features: [
      { text: "每月 10K 请求", included: true },
      { text: "社区模型", included: true },
      { text: "共享计算池", included: true },
      { text: "单一区域", included: true },
      { text: "优先路由", included: false },
      { text: "专属支持", included: false },
    ],
    cta: "免费部署",
    highlighted: false,
  },
  {
    ...
    period: "/ 月",
    tag: "推荐",
    description: "生产级。低于 5ms 延迟。99.97% 在线 SLA。",
    features: [
      { text: "不限请求量", included: true },
      { text: "全部 147 个基础模型", included: true },
      { text: "专属计算资源", included: true },
      { text: "12 区域边缘部署", included: true },
      { text: "优先路由", included: true },
      { text: "专属支持", included: false },
    ],
    cta: "开始构建",
    highlighted: true,
  },
  {
    ...
    period: "",
    tag: null,
    description: "物理隔离。本地部署。完整运维控制。",
    features: [
      { text: "全部不限量", included: true },
      { text: "定制模型微调", included: true },
      { text: "专属集群", included: true },
      { text: "50+ 边缘区域", included: true },
      { text: "定制 SLA", included: true },
      { text: "24/7 专属工程支持", included: true },
    ],
    cta: "联系销售",
    highlighted: false,
  },
    ...
    >
      ...
      <div className="px-5 pt-6 pb-4">
        <div className="flex items-baseline gap-1">
          {isCustom ? (
            <span className="text-3xl lg:text-4xl font-mono font-bold tracking-normal">定制</span>
          ) : (
...
export function PricingSection() {
  return (
    <section className="w-full px-6 py-20 lg:px-12">
      ...
      >
        <div className="flex flex-col gap-3">
          <h2 className="text-2xl lg:text-3xl font-mono font-bold tracking-normal uppercase text-foreground text-balance">
            选择你的计算层级
          </h2>
          <p className="text-xs lg:text-sm font-mono text-muted-foreground leading-relaxed max-w-md">
            所有层级都包含零配置部署、内置监控，以及 SYS.INT inference API 访问权限。
          </p>
        </div>
        <StatusLine />
      </motion.div>
