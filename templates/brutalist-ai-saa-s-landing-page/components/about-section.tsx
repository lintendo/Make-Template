...
import aboutIsometric from "../public/images/about-isometric.jpg?url"
...
/* ── stat block ── */
const STATS = [
  { label: "已部署模型", value: "147" },
  { label: "边缘区域", value: "50+" },
  { label: "推理调用", value: "12.8B" },
  { label: "平均延迟", value: "4.2ms" },
]
...
function StatBlock({ label, value, index }: { label: string; value: string; index: number }) {
  return (
    ...
    >
      ...
      <span className="text-xl lg:text-2xl font-mono font-bold tracking-normal">
          ...
          <div className="flex-1 flex flex-col justify-between px-5 py-6 lg:py-8">
            <div className="flex flex-col gap-6">
              <motion.h2
                ...
                className="text-2xl lg:text-3xl font-mono font-bold tracking-normal uppercase text-balance"
              >
                为原始智能构建的
                <br />
                <span className="text-[#ea580c]">基础设施</span>
              </motion.h2>
              ...
              >
                <p className="text-xs lg:text-sm font-mono text-muted-foreground leading-relaxed">
                  我们构建位于模型与用户之间的底层基座。没有黑箱抽象，没有魔法，只有确定性路由、低于 5ms 的推理，以及覆盖每个边缘节点的透明运维控制。
                </p>
                <p className="text-xs lg:text-sm font-mono text-muted-foreground leading-relaxed">
                  SYS.INT 由深耕超大规模分布式计算十年的系统工程师创立。我们相信 AI 基础设施应该可检查、可审计，并且足够硬核地快。
                </p>
              </motion.div>
