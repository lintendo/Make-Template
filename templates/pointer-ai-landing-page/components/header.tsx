...
export function Header() {
  const navItems = [
    { name: "功能", href: "#features-section" },
    { name: "价格", href: "#pricing-section" },
    { name: "客户评价", href: "#testimonials-section" }, // Changed from Docs to Testimonials
  ]
    ...
    <header className="w-full py-4 px-6">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <Button
            asChild
            className="hidden md:inline-flex bg-secondary text-secondary-foreground hover:bg-secondary/90 px-6 py-2 rounded-full font-medium shadow-sm"
          >
          ...
          <Sheet>
            ...
            <SheetContent side="bottom" className="bg-background border-t border-border text-foreground">
              <SheetHeader>
                <SheetTitle className="text-left text-xl font-semibold text-foreground">导航</SheetTitle>
              </SheetHeader>
