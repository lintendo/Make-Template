...
const CardTemplate = forwardRef<CardTemplateRef, CardTemplateProps>(
  ({ userName, variant, onTextureReady, city, date }, ref) => {
    ...
    const imageSrc = variant === "dark" ? darkCardBaseSrc : lightCardBaseSrc;
    ...
    const captureTexture = async () => {
      ...
      const displayName = userName || "你的名字";
      ctx.fillStyle = textColor;
      ctx.font = 'normal 48px "Geist Mono", "Noto Sans Mono CJK SC", "Sarasa Mono SC", "PingFang SC", monospace';
      ctx.textAlign = "right";
      ...
      if (city) {
        ...
        cityRender.font = 'normal 48px "Geist Mono", "Noto Sans Mono CJK SC", "Sarasa Mono SC", "PingFang SC", monospace';
      ...
      if (date) {
        ...
        dateRender.font = 'normal 48px "Geist Mono", "Noto Sans Mono CJK SC", "Sarasa Mono SC", "PingFang SC", monospace';
    ...
    const exportCard = () => {
      ...
      fullCtx.font = 'normal 48px "Geist Mono", "Noto Sans Mono CJK SC", "Sarasa Mono SC", "PingFang SC", monospace';
