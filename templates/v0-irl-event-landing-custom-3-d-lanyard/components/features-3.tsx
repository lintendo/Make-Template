                    ...
                    <Card
                        ...
                        <div className="group shadow-zinc-950/5">
                            <CardHeader className="pb-3">
                                ...
                                <h3 className="mt-6 font-medium text-xl">免费 v0 Credits</h3>
                            </CardHeader>

                            <CardContent>
                                <p className="text-sm text-muted-foreground">可用于使用 v0 搭建项目的 Credits。</p>
                            </CardContent>
                        </div>
                        ...
                        <div className="group shadow-zinc-950/5">
                            <CardHeader className="pb-3">
                                ...
                                <h3 className="mt-6 font-medium text-xl">全球作品廊</h3>
                            </CardHeader>

                            <CardContent>
                                <p className="mt-3 text-sm text-muted-foreground">所有项目都会进入全球线上展览</p>
                            </CardContent>
                        </div>
                        ...
                        <div className="group shadow-zinc-950/5">
                            <CardHeader className="pb-3">
                                ...
                                <h3 className="mt-6 font-medium text-xl">社区投票</h3>
                            </CardHeader>

                            <CardContent>
                                <p className="mt-3 text-sm text-muted-foreground">创作者为喜欢的作品投票，优胜者获得奖品</p>
                            </CardContent>
                        </div>
                    </Card>
                </AnimatedGroup>
