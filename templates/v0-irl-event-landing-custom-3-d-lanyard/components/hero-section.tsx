...
import VercelWordmarkIcon from "./icons/vercel-wordmark-icon";
import GlobantLogoIcon from "./icons/globant-logo-icon";
                    ...
                    <div className="relative mx-auto flex max-w-xl flex-col px-6 lg:block">
                        <div className="mx-auto max-w-2xl text-center lg:ml-0 lg:text-left">
                            ...
                            <TextEffect
                                ...
                                v0 即将发布迄今最大的一次产品更新。我们会通过全球各地的 v0 IRL 一起庆祝。
                            </TextEffect>
                            <AnimatedGroup
                                variants={{
                                    container: {
                            ...
                            >
                                <Button
                                    ...
                                    <a href="#registration">
                                        <span className="text-nowrap">立即报名</span>
                                    </a>
                                </Button>
                                <Button
                                    key={2}
                                    ...
                                    <a href="mailto:events@v0.dev">
                                        <span className="text-nowrap">联系主办方</span>
                                    </a>
                                </Button>
                            </AnimatedGroup>
                        </div>
                ...
                >
                    ...
                    <div className="flex flex-col items-center md:flex-row">
                        <div className="md:max-w-44 md:border-r md:pr-6">
                            <p className="text-end text-sm font-mono uppercase">支持方</p>
                        </div>
