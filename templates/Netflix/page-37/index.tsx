 ...
 */
const EpisodeRow = ({ num, title, duration, imgSrc, synopsis, isDownloaded }) => (
    <div className="flex flex-col mb-[22px]">
        <div className="flex items-center justify-between mb-[8px] px-[16px]">
             ...
             {/* Download State Action Geometry */}
             <div className="w-[40px] h-[40px] flex justify-end items-center cursor-pointer active:scale-90 transition-transform">
                  {isDownloaded ? (
                       <div className="w-[18px] h-[18px] bg-[#0A84FF] border border-[#0A84FF] rounded-[2px] flex justify-center items-center shadow-[0_1px_4px_rgba(10,132,255,0.4)]">
                       ...
                       <div className="w-[20px] h-[20px] relative mt-[2px] mr-[2px]">
...
/**
 * @name Netflix "Episodes Array Block" Deep Scroll State - Page 37
 */
  ...
  return (
    <div className="flex flex-col h-screen max-w-md mx-auto bg-[#141414] text-[#FAFAFA] font-sans relative select-none">
      ...
      <div className="flex-1 overflow-y-auto w-full custom-hide-scrollbar pt-[90px] relative z-10 pb-[100px]">
          ...
          {/* Sub-Classification Header Topology */}
          ...
          {/* Sequential Data Render Block (Episodes Array) */}
          <EpisodeRow 
              num="1" 
              title="Episode 1" 
              duration="58m" 
          ...
          <EpisodeRow 
              ...
              isDownloaded={true} // Triggers rendering of the Blue Check UI Box
          />
          ...
          <EpisodeRow 
              ...
              duration="57m" 
              imgSrc={ep4Thumb} 
              synopsis="In the wake of another attack, investigators grow increasingly suspicious of Budd, as his state of mind" // Artificially truncated logic for seamless OS Nav cut
              isDownloaded={false} 
          />
      ...
      <div className="absolute bottom-0 w-full h-[88px] bg-black/95 backdrop-blur-md border-t border-[#1C1C1C] flex px-[5px] pt-[8.5px] z-50 pointer-events-auto">
          ...
          <button className="relative flex-1 flex flex-col items-center gap-[4px] opacity-60 transition-opacity hover:opacity-100 active:scale-95">
              <div className="relative">
                  ...
                  {/* Alert Ping Logic: Active Download Flag Node */}
